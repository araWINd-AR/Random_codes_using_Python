...
def draw_heart_with_message(scale, message):
    ...
    heart_turtle.write(
        message, 
        align="center", 
        font=("Georgia", int(scale * 1.8), "bold") # Font size scaled to the heart
    )
